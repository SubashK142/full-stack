      ...
      <div key="Payment">
        <div className="App-payment">
          ...
          <form onSubmit={this.handleSubmit}>
            ...
            <div className="form-group">
              <input
                style={{ padding: '10px', borderRadius: '10px', marginTop: '5px' ,width:'300px'}}
                type="text"
                name="name"
                className="form-control"
                placeholder="Name"
            ...
            <div className="form-actions">
              <button className="btn btn-primary btn-block"  style={{backgroundColor:'blue', borderRadius: '10px',marginLeft:'100px',width:'100px',padding:'10px',color:'white' }}>PAY</button>
            </div>
